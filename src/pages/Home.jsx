...
function Home() {
  ...
  const aboutUsData = [
    ...
    },
    {
      index: 2,
      title:
        "Helps leverage the tremendous power of People and technology to provide Help and Information",
      icon: <Cpu className="h-14 w-14 text-sky-600" />,
    },
    {
      index: 3,
      title:
        "Enables the probability of saving life’s through first responders",
  ...
  const steps = [
    {
      title: "Sign Up",
      description:
        "Create an account on our platform by providing your basic information.",
      icon: (
        <svg
    ...
    },
    {
      ...
      description:
        "Complete your profile with medical information and emergency contacts.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
    ...
    },
    {
      ...
      description:
        "Receive a unique QR code that contains your emergency information.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
    ...
    <div className="max-w-7xl mx-auto h-fit antialiased">
      ...
      <section className="py-16 bg-gradient-to-br ">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl md:text-6xl font-bold text-center text-black dark:text-white mb-12">
            How to Use <span className="text-sky-600 font-bold">myresQR</span>{" "}
          </h2>
            ...
            <div className="space-y-12">
              {steps.map((step, index) => (
                ...
                >
                  ...
                  <Card
                    className={`w-1/2 border-sky-500 border-2 bg-sky-500/20 dark:bg-sky-500/20 ${
                      index % 2 === 0 ? "mr-8" : "ml-8"
                    } `}
                  >
      ...
      <section className="w-full h-fit">
        <h1 className="text-3xl md:text-5xl">
          About <span className="text-sky-600 font-bold">MyResQR</span>{" "}
        </h1>
        <div className="flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 md:space-x-6 my-10 h-full">
          {aboutUsData.map((data, index) => (
            <div
              key={index}
              className="w-full md:w-1/3  h-[10rem] md:h-[14rem] flex flex-col justify-center items-center md:items-baseline md:space-y-10 border-black dark:border-white border-2 px-4 py-6 rounded-2xl dark:hover:border-sky-600 hover:border-sky-600 hover:scale-105 transition-all ease-in-out duration-300"
            >
